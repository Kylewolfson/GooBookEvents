...
public class GoogleSyncActivity extends Activity
    ...
    private List<FacebookEvent> mFacebookEvents = new ArrayList<FacebookEvent>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFacebookEvents = Parcels.unwrap(getIntent().getParcelableExtra("events"));
        System.out.println(mFacebookEvents.get(0));
