...
public class GoogleCalendarPollActivity extends Activity
    ...
    void showGooglePlayServicesAvailabilityErrorDialog(
        ...
        Dialog dialog = apiAvailability.getErrorDialog(
                GoogleCalendarPollActivity.this,
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                Intent intent = new Intent(GoogleCalendarPollActivity.this, EventSelect.class);
                intent.putExtra("google events", mEventList);
